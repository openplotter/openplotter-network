...
`sudo apt install openplotter-settings python3-wxgtk4.0 hostapd dnsmasq bridge-utils dialog usbmuxd libnss-mdns avahi-utils libavahi-compat-libdnssd-dev`
